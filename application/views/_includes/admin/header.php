    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary sidebar-no-expand">
            ...
            <a href="<?= base_url('dashboard') ?>" class="brand-link navbar-dark">
                <img src="<?= base_url(); ?>asset-baru/img/logo/logoPrigenPutihNew.png" alt="Logo" class="w-100">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if (userdata()->role == "admin") : ?>
                            <li class="nav-header">CMS For News</li>
                            <li class="nav-item">
                            ...
                            <li class="nav-header">CMS For Per Pages</li>
                            ...
                            <li class="nav-item menu-close">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('PlanYourVisit/data'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Section | Plan Your Visit</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('HubungiKami/data'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Section | Hubungi Kami</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('HomeBanner/data'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Banner</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('AdsBanner/data'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Ads Banner</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item menu-close">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('BabyZoo/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Baby Zoo</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('Australiana/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Australiana</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('SpecialExperience/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item menu-close">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('SafariAdventure/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Safari Andventure</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('SafariAnimalShow/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Safari Animal Show</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('RecreationArea/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>RecreationArea</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item menu-close">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url('Package/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Package</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('ParkMap/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>ParkMap</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?= base_url('Restaurant/data') ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Restaurant</p>
                                        </a>
                                    </li>
